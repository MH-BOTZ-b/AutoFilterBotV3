    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
        ...
        try:
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('SHARE ME 🔄', url=f'{PICS}')
                    ]
                    ]
        ...
        await message.reply_text(
            ...
            reply_markup=reply_markup
                [[
                InlineKeyboardButton("🔎 Search Movies 🔍", switch_ine_query_current_chat='')
                ],[
                InlineKeyboardButton("Moviez club", callback_"),
                InlineKeyboardButton("About 😊", callback_data="aut")
                ]]
            )
        )
        StopPropagation
...
async def bot_info(bot, message):
    buttons = [
        [
            ...
            InlineKeyboardButton(' Other Bots 🤖', url=f'{TOTURIAL}')
        ]
        ]
